...
#         newly_planned_agents = [*agents_with_newly_created_plan, *agents_with_prev_plan]
#         from_n_to_a_dict = curr_n_name_to_agent_dict
#         backward_step_agents = [a for a in self.agents_to_return if a not in newly_planned_agents]
...
#
#         all_update_return_roads(newly_planned_agents, iteration)
#         calc_backward_road(
#             backward_step_agents, newly_planned_agents, self.agents_to_return, self.agents_dict, from_n_to_a_dict,
